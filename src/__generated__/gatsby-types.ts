...
type MdxFrontmatterFilterInput = {
  ...
  readonly hero_image: Maybe<FileFilterInput>;
  readonly hero_image_alt: Maybe<StringQueryOperatorInput>;
  readonly hero_image_credit_text: Maybe<StringQueryOperatorInput>;
  readonly hero_image_credit_link: Maybe<StringQueryOperatorInput>;
};
...
type staticUsersshogonakanodesudevjsblogShgnknGatsbysrccomponentslayoutTsx3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type staticUsersshogonakanodesudevjsblogShgnknGatsbysrccomponentslayoutTsx3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
type BlogPostsQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<(
      Pick<Mdx, 'slug' | 'id'>
      & { readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'date' | 'title'>> }
    )> } };

type pageUsersshogonakanodesudevjsblogShgnknGatsbysrcpagesblogindexJs4032864724QueryVariables = Exact<{ [key: string]: never; }>;


type pageUsersshogonakanodesudevjsblogShgnknGatsbysrcpagesblogindexJs4032864724Query = { readonly allMdx: { readonly nodes: ReadonlyArray<(
      Pick<Mdx, 'slug' | 'id'>
      & { readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'date' | 'title'>> }
    )> } };

type pageUsersshogonakanodesudevjsblogShgnknGatsbysrcpagesblogmdxSlugJs3501979378QueryVariables = Exact<{
  id: Maybe<Scalars['String']>;
}>;


type pageUsersshogonakanodesudevjsblogShgnknGatsbysrcpagesblogmdxSlugJs3501979378Query = { readonly mdx: Maybe<(
    Pick<Mdx, 'body'>
    & { readonly frontmatter: Maybe<(
      Pick<MdxFrontmatter, 'title' | 'date' | 'hero_image_alt' | 'hero_image_credit_link' | 'hero_image_credit_text'>
      & { readonly hero_image: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
...
type staticUsersshogonakanodesudevjsblogShgnknGatsbysrccomponentslayoutJs3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type staticUsersshogonakanodesudevjsblogShgnknGatsbysrccomponentslayoutJs3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
